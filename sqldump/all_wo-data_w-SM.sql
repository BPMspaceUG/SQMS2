...
--
-- Dumping data for table `role_liamuser`
--

LOCK TABLES `role_liamuser` WRITE;
/*!40000 ALTER TABLE `role_liamuser` DISABLE KEYS */;
/*!40000 ALTER TABLE `role_liamuser` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_answer` (
  ...
  `sqms2_Answer_History` mediumtext CHARACTER SET latin1,
...
) ENGINE=InnoDB AUTO_INCREMENT=55038801 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_answer`
--

LOCK TABLES `sqms2_answer` WRITE;
/*!40000 ALTER TABLE `sqms2_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_answer` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=45034471 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_answer_text`
--

LOCK TABLES `sqms2_answer_text` WRITE;
/*!40000 ALTER TABLE `sqms2_answer_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_answer_text` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_examsetversion` (
  ...
  `sqms2_ExamSetVersion_title` mediumtext CHARACTER SET latin1,
  `sqms2_ExamSetVersion_History` mediumtext CHARACTER SET latin1,
...
--
-- Dumping data for table `sqms2_examsetversion`
--

LOCK TABLES `sqms2_examsetversion` WRITE;
/*!40000 ALTER TABLE `sqms2_examsetversion` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_examsetversion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_question` (
  ...
  `sqms2_Question_History` mediumtext CHARACTER SET latin1,
  `_LIAMUSER_ID` bigint(20) DEFAULT NULL,
  `sqms2_Question_Version` int(11) DEFAULT '1',
  `sqms2_Question_type` enum('CALCULATED','CALCULATED MULTI-CHOICE','CALCULATED SIMPLE','DESCRIPTION','ESSAY','MATCHING','EMBEDDED ANSWERS','MULTIPLE CHOICE','SHORT ANSWER','NUMERICAL','RANDOM SHORT-ANSWER MATCHING','TRUE/FALSE') CHARACTER SET latin1 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=85647689 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_question`
--

LOCK TABLES `sqms2_question` WRITE;
/*!40000 ALTER TABLE `sqms2_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_question` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=6503460 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_question_answer`
--

LOCK TABLES `sqms2_question_answer` WRITE;
/*!40000 ALTER TABLE `sqms2_question_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_question_answer` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sqms2_question_examsetversion`
--

LOCK TABLES `sqms2_question_examsetversion` WRITE;
/*!40000 ALTER TABLE `sqms2_question_examsetversion` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_question_examsetversion` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sqms2_question_examsetversion_answer`
--

LOCK TABLES `sqms2_question_examsetversion_answer` WRITE;
/*!40000 ALTER TABLE `sqms2_question_examsetversion_answer` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_question_examsetversion_answer` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=75034154 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_question_text`
--

LOCK TABLES `sqms2_question_text` WRITE;
/*!40000 ALTER TABLE `sqms2_question_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_question_text` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_syllabus` (
  ...
  `sqms2_Syllabus_titel` mediumtext CHARACTER SET latin1,
  `sqms2_Syllabus_History` mediumtext CHARACTER SET latin1,
...
) ENGINE=InnoDB AUTO_INCREMENT=90034799 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabus`
--

LOCK TABLES `sqms2_syllabus` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabus` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabus` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=80035027 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabus_desc`
--

LOCK TABLES `sqms2_syllabus_desc` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabus_desc` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabus_desc` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=60034371 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabus_syllabuschapter`
--

LOCK TABLES `sqms2_syllabus_syllabuschapter` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabus_syllabuschapter` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabus_syllabuschapter` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=10034781 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabus_topic`
--

LOCK TABLES `sqms2_syllabus_topic` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabus_topic` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabus_topic` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_syllabuschapter` (
  ...
  `sqms2_SyllabusChapter_titel` mediumtext CHARACTER SET latin1,
  `sqms2_SyllabusChapter_History` mediumtext CHARACTER SET latin1,
...
) ENGINE=InnoDB AUTO_INCREMENT=50034926 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabuschapter`
--

LOCK TABLES `sqms2_syllabuschapter` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabuschapter` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabuschapter` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=30034970 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabuschapter_desc`
--

LOCK TABLES `sqms2_syllabuschapter_desc` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabuschapter_desc` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabuschapter_desc` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=95034461 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_syllabuschapter_question`
--

LOCK TABLES `sqms2_syllabuschapter_question` WRITE;
/*!40000 ALTER TABLE `sqms2_syllabuschapter_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_syllabuschapter_question` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_text` (
  ...
  `sqms2_Text` mediumtext CHARACTER SET latin1,
  `sqms2_text_History` mediumtext CHARACTER SET latin1,
  `sqms2_language_iso_short` enum('DE','EN','FR','SP','IT') CHARACTER SET latin1 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=70034258 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_text`
--

LOCK TABLES `sqms2_text` WRITE;
/*!40000 ALTER TABLE `sqms2_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_text` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sqms2_text_text`
--

LOCK TABLES `sqms2_text_text` WRITE;
/*!40000 ALTER TABLE `sqms2_text_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_text_text` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms2_topic` (
  ...
  `sqms2_Topic_title` mediumtext CHARACTER SET latin1,
  `sqms2_Topic_History` mediumtext CHARACTER SET latin1,
...
) ENGINE=InnoDB AUTO_INCREMENT=20034859 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms2_topic`
--

LOCK TABLES `sqms2_topic` WRITE;
/*!40000 ALTER TABLE `sqms2_topic` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_topic` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sqms2_topic_question`
--

LOCK TABLES `sqms2_topic_question` WRITE;
/*!40000 ALTER TABLE `sqms2_topic_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_topic_question` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `sqms2_topic_role`
--

LOCK TABLES `sqms2_topic_role` WRITE;
/*!40000 ALTER TABLE `sqms2_topic_role` DISABLE KEYS */;
/*!40000 ALTER TABLE `sqms2_topic_role` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `_nodes` AS select 'sqms2_syllabus' AS `ObjectType`,`sqms2_syllabus`.`sqms2_Syllabus_id` AS `ObjectID`,`sqms2_syllabus`.`state_id` AS `ObjectStateID` from `sqms2_syllabus` union select 'sqms2_syllabuschapter' AS `ObjectType`,`sqms2_syllabuschapter`.`sqms2_SyllabusChapter_id` AS `ObjectID`,`sqms2_syllabuschapter`.`state_id` AS `ObjectStateID` from `sqms2_syllabuschapter` union select 'sqms2_examsetversion' AS `ObjectType`,`sqms2_examsetversion`.`sqms2_ExamSetVersion_id` AS `ObjectID`,`sqms2_examsetversion`.`state_id` AS `ObjectStateID` from `sqms2_examsetversion` union select 'sqms2_question' AS `ObjectType`,`sqms2_question`.`sqms2_Question_id` AS `ObjectID`,`sqms2_question`.`state_id` AS `ObjectStateID` from `sqms2_question` union select 'sqms2_answer' AS `ObjectType`,`sqms2_answer`.`sqms2_Answer_id` AS `ObjectID`,`sqms2_answer`.`state_id` AS `ObjectStateID` from `sqms2_answer` union select 'sqms2_text' AS `ObjectType`,`sqms2_text`.`sqms2_Text_id` AS `ObjectID`,`sqms2_text`.`state_id` AS `ObjectStateID` from `sqms2_text` union select 'sqms2_topic' AS `ObjectType`,`sqms2_topic`.`sqms2_Topic_id` AS `ObjectID`,`sqms2_topic`.`state_id` AS `ObjectStateID` from `sqms2_topic` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-09-23  8:27:33
